...
%
\begin{exer}
Define $\varphi : A^\pm_n \to A^\pm_n$ by $\varphi(v) = -v$ and $\varphi(vw) = (wv)$, and extending linearly to sums. Does $\varphi(x)\cdot x$ define a norm on $A^\pm_n$?
\end{exer}
%
\begin{exer}
...
%
\begin{exer}
Given a unital associative algebra $A$ and $A$-modules $M$ and $N$, how would you form the direct sun. Can you tensor them?
\end{exer}
%
\begin{exer}
Let $V$ be a vector space and $b : V \times V \to V$ a bilinear form. We want to construct the Clifford algebra $\Cliff(V,b)$ as the ``best" associative unital $\R$-algebra generated by $V$ subject to the relation $v_1v2 + v_2v_1 = 2b(v_1,b_2)1_A$, where $1_A$ denotes the multiplicative unit in $A$.
\end{exer}
%
\end{document}