...
%
\begin{quest}
From before, we have a map $G \to SO(n)$ where $G$ is the group generated by unit vectors in $\R^n$. Extending this to an algebra map $C_{-n} \to \End(R_n)$, is this representation irreducible?
\end{quest}
%
\begin{quest}
