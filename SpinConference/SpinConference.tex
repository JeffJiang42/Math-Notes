...
$$\mathfrak{o}(p,q) = \set{X \in M_{p+1}\R ~:~ MX = -X^TM} $$
...
$$e^{te_ie_j} = \left( \sum_{k=1}^\infty \frac{t}{2k !} \right)  + \left( \sum_{k = 1}^\infty \frac{te_ie_j}{(2k - 1)!}\right) = \cosh t + (\sin th)e_ie_j$$
