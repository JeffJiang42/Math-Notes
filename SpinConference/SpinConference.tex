...
$$\omega(Tv_i, Tv_j, Tv_k, Tv_\ell) = \det T \omega (v_1, v_2, v_3, v_3) = \omega(v_12,v_2,v_3,v_4)$$
So $T_*$ preserves $B$, giving us a homomorphism $\Aut(V, \omega) \to \Aut(\bigwedge^2V, B)$.
%
\end{document}