...
%
\begin{exer}
Given a ring homomorphism $B \to A$, any $A$-modules becomes a $B$ module, which givrs us a functor $\mathsf{Mod}_A \to \mathsf{Mod}_B$. Show that this functor is right adjoint to the functor that maps a $B$-module $M$ to $M \otimes_B A$.
\end{exer}
%
\begin{proof}
