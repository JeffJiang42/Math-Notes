...
such that given any $f: C \to B$, the following diagram commutes
$$\xymatrix{
...
\begin{proof} \enumbreak
\begin{enumerate}
\item Let $C = A$, in which case we have the map $i_A : \hom(A,A) \to \hom(A,A')$. We claim that the map $g :  A \to A'$ we are looking for is $i_A(\id_A)$. We note that the following diagram commutes
$$\xymatrix{
\hom(A,A) \ar[d] \ar[r]^{i_A} & \hom(A,A') \ar[d] \\
