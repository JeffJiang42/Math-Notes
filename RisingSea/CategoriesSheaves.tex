...
\end{tikzcd}$$
We also want to show it for the other diagram, but the proof will be near identical, so we only do it for this one. let $\varphi \in \hom(X \otimes_A N, B)$. We compute
\begin{align*}
