...
%
\begin{exer}
Show that if the two squares in the following diagrame are commutative, then the outer rectangle is commutative as well
$$\xymatrix{
U \ar[d]\ar[r] & V \ar[d] \\
W \ar[d] \ar[r] & X \ar[d] \\
Y  \ar[r] & Z
