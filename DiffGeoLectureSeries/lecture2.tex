...
$\dim M$-form, we call it a \ib{top degree form}.
\end{defn}
%
...
\end{prop}
%
Using this, there's a simple way to express the pullback ofa top degree form.
...
exactly the right manny for integration, as they encapsulate how parallelopipeds
