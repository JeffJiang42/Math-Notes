...
&= 2\star\inv L\circ\iota_1\star\inv - \varepsilon_{d\zbar^1}\star L\star
\end{align*}
where the last equality uses the fact that
$\star\varepsilon_{d\zbar^1} = 2\iota_1\star\inv$ (an immediate consequence of Lemma
7.4), and lemma 7.5. Applying Lemma 7.4. once more, we get
\[
2\star\inv L\circ\iota_1\star\inv - \varepsilon_{d\zbar^1}\star L\star
= 2\star\inv L\circ\iota_1\star\inv - 2\star\inv\iota_1\circ L\star
\]
We then apply Lemma 7.5. to obtain
\begin{align*}
2\star\inv L\circ\iota_1\star\inv - 2\star\inv\iota_1\circ L\star
= 2\star\inv\left(\iota_1\circ L - \frac{i}{2}\varepsilon_{d\zbar^1}\right)
-2\star\inv\left(L \circ \iota_1 + \frac{i}{2}\varepsilon_{d\zbar^1}\right) \\
&=
\end{align*}
%
\end{proof}
