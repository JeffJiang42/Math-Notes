...
theorem. Therefore, its adjoint, $\Lambda$, is surjective, giving the
short exact sequence
\[\begin{tikzcd}
0 \ar[r] & \mathcal{H}^{p,q}_{\mathrm{Prim}} \ar[r] & \mathcal{H}^{p,q}(X)
\ar[r, "\Lambda"] & \mathcal{H}^{p-1,q-1}(X) \ar[r] & 0
\end{tikzcd}\]
which proves the desired equality after appealing to the isomorphism between
