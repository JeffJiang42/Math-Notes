...
\begin{enumerate}
  ...
  \item $\partial^* = -\star\inv\partial\star$
  \item $\dbar^* = -\star\inv\dbar\star$
\end{enumerate}
\end{defn}
%
\begin{prop}
The operators $d^*$, $\partial^*$, and $\dbar^*$ are the adjoints to their respective
operators with respect to the appropriate $L^2$ metrics.
\end{prop}
%
\begin{proof}
