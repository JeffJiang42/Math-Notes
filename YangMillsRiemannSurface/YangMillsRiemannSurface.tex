...
%
% TODO fix the HN-type vectors, length shound be rank of bundle - repeat slopes
% depending on the rank of the subbundle in the filtration.
%
...
%TODO compute complex codimension using Riemann-Roch and vanishing of H^0
